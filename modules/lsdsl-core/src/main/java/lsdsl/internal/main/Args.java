...
@CommandLine.Command(sortOptions = false, synopsisHeading = "LsDSL : A DSL Platform\n\n")
public class Args
{
    @Option(names = {"-h", "--help"}, description = "Print Help Message and Exit")
    private boolean help = false;

    @Option(names = {"-v", "--version"}, description = "Print LsDSL Version and Exit")
    ...
    @Option(names = {"-V", "--variable"}, description = "-V key=value syntax can be used to supply named variables from command line to the executed script. ex: " + LsDSL.CMD + " -V country='India' -e 'println country.toUpperCase()'")
